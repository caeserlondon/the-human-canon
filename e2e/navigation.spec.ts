...
test.describe("Navigation", () => {
  ...
  test("footer links work", async ({ page }) => {
    ...
    await page.getByTestId("footer").getByRole("link", { name: "About" }).click();
    await expect(page).toHaveURL("/about");

    await page.getByTestId("footer").getByRole("link", { name: "Privacy Policy" }).click();
    await expect(page).toHaveURL("/privacy");

    await page.getByTestId("footer").getByRole("link", { name: "Terms" }).click();
    await expect(page).toHaveURL("/terms");

    await page.getByTestId("footer").getByRole("link", { name: "Contact" }).click();
    await expect(page).toHaveURL("/contact");

    await page.getByTestId("footer").getByRole("link", { name: "Public Domain" }).click();
