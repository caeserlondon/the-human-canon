						...
						<div className='mx-auto max-w-7xl w-full px-4'>
							<div className='max-w-2xl hero-content'>
								...
								<p className='mt-5 text-base leading-relaxed text-muted hero-subtitle'>
									A curated digital institution for timeless works across
									civilizations and centuries— rewritten with modern clarity for
									people who want depth, not fluff.
								</p>
								<div className='mt-7'>
									<Link
					...
					{featuredBooks.length === 0 ? (
						<div className='hc-card mt-6 p-12 text-center'>
							<p className='text-muted'>
								The canon is being built. Check back soon.
							</p>
						</div>
					) : (
									...
									<div className='min-w-0 flex-1'>
										...
										<p className='mt-0.5 text-xs text-muted2'>
											{book.publicationYear < 0
												? `${Math.abs(book.publicationYear)} BCE`
