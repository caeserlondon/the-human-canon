...
function SignInForm() {
  ...
  const [error, setError] = useState<string | null>(
    errorParam === "auth" ? "Google sign-in failed. Please check your configuration and try again." : null
  );
    ...
    <main className="hc-bg flex min-h-screen flex-col">
      ...
      <div className="mx-auto flex flex-1 flex-col items-center justify-center px-4 py-16">
        ...
        <p className="mt-6 text-sm text-muted">
          ...
          <Link href="/sign-up" className="text-gold hover:text-gold2 font-medium">
            Sign up
          </Link>
        </p>
      </div>
